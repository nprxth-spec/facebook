          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="space-y-3">
              <Button
                ...
                size="lg"
                className="w-full gap-3 font-medium bg-[#1877F2] hover:bg-[#166fe5] text-white border-0 cursor-pointer"
                disabled={loading}
              >
                <FacebookIcon />
                {isThai ? "เชื่อมต่อ Facebook" : "Connect Facebook"}
              ...
              <Button
                ...
                variant="ghost"
                size="lg"
                className="w-full text-gray-500 dark:text-gray-400 cursor-pointer"
              >
        ...
        <div className="w-full max-w-md">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="w-full gap-3 font-medium border-gray-300 hover:border-gray-400 cursor-pointer"
              disabled={loading}
            >
              <GoogleIcon />
